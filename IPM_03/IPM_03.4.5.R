...
se.sa.e <- 0.005       # Uncertainty of mean sa as SE on natural scale
...
jags.data <- list(alpha.sj=getBeta2Par(mean.sj, se.sj.e)[1],
    ...
    mean.f1=mean.f1, mean.fa=mean.fa, se.f1.e=se.f1.e, se.fa.e=se.fa.e,
    sd.sj.t=sd.sj.t, sd.sa.t=sd.sa.t, sd.f1.t=sd.f1.t, sd.fa.t=sd.fa.t,
    T=T, N1=N1, N2=N2)
...
out7 <- jags(jags.data, NULL, parameters, "model7.txt", n.adapt=na,
