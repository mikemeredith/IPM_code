...
# plot(N[1,], type="l", lwd=1.5, ylab="Population size", xlab="Time", axes=FALSE, ylim=range(N))
plot(N[1,], type="l", lwd=1.5, ylab="Population size", xlab="Time", axes=FALSE, ylim=range(N, na.rm=TRUE))
axis(1)
axis(2, las=1)
