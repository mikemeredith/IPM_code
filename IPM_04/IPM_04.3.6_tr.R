...
# ni <- 100000; nb <- 50000; nc <- 3; nt <- 50; na <- 5000   # 23 min
ni <- 10000; nb <- 5000; nc <- 3; nt <- 5; na <- 500  #  # ~~~ for testing
...
# gamma        4.919  0.352    4.240    4.918    5.646    FALSE 1 1.001  3000
# phi          0.800  0.026    0.744    0.802    0.847    FALSE 1 1.002  1427
# rho          0.240  0.027    0.193    0.238    0.298    FALSE 1 1.002  1407
# p            0.396  0.020    0.356    0.396    0.435    FALSE 1 1.000  3000
# ntot[1]    490.508 26.949  441.000  489.000  548.025    FALSE 1 1.001  3000
# ntot[2]    516.968 27.461  467.000  515.000  576.000    FALSE 1 1.001  3000
# ntot[3]    546.495 28.558  494.000  545.000  608.000    FALSE 1 1.000  3000
# ntot[4]    559.367 29.840  507.000  558.000  623.000    FALSE 1 1.000  3000
# ntot[5]    576.243 31.161  520.000  575.000  643.000    FALSE 1 1.001  3000
# ntot[6]    601.033 32.524  542.000  599.000  671.000    FALSE 1 1.001  3000
# ntot[7]    636.714 33.318  577.975  635.000  709.025    FALSE 1 1.001  3000
# ntot[8]    659.010 34.381  596.000  657.000  733.025    FALSE 1 1.001  3000
# ntot[9]    681.968 35.798  617.000  680.000  758.000    FALSE 1 1.001  3000
# ntot[10]   694.363 37.785  624.975  692.500  774.000    FALSE 1 1.001  3000
# ntot[11]   728.986 39.654  657.000  727.000  812.000    FALSE 1 1.001  3000
# ntot[12]   758.156 42.915  680.000  756.000  850.000    FALSE 1 1.000  3000
# N[1,1]       4.412  1.137    3.000    4.000    7.000    FALSE 1 1.001  2235
# N[2,1]       4.219  1.018    3.000    4.000    6.000    FALSE 1 1.000  2440
# N[3,1]       5.600  1.271    3.000    6.000    8.000    FALSE 1 1.002   781
# [... output truncated ...]
