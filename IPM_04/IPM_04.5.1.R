...
out17 <- jags(jags.data, inits, parameters, "model14.txt",
...
out18 <- jags(jags.data, inits, parameters, "model15.txt",
    n.iter=ni, n.burnin=nb, n.chains=nc, n.thin=nt, n.adapt=na, parallel=TRUE)
...
print(marr)
 ...
 # [1,]    3    2    1    2    0    0    0    0    0     0     2
 # [2,]    0    5    1    3    0    0    0    0    0     0     4
 # [3,]    0    0    3    4    3    1    1    0    0     0     5
 # [4,]    0    0    0    7    2    1    0    0    0     0     5
 # [5,]    0    0    0    0   12    1    1    3    0     0     9
 # [6,]    0    0    0    0    0   10    3    3    0     0    11
 # [7,]    0    0    0    0    0    0    9    5    1     1     7
 # [8,]    0    0    0    0    0    0    0    7    6     2     9
 # [9,]    0    0    0    0    0    0    0    0    5     6    17
# [10,]    0    0    0    0    0    0    0    0    0     8    14

rel <- rowSums(marr)
print(rel)

# [1] 10 13 17 15 26 27 23 24 28 22
...
out19 <- jags(jags.data, inits, parameters, "model16.txt",
    n.iter=ni, n.burnin=nb, n.chains=nc, n.thin=nt, n.adapt=na, parallel=TRUE)
...
jags.data <- list(marr.j=marr[,,1], marr.a=marr[,,2], nyears=dim(marr)[2],
...
# Call JAGS (ART <1 min), check convergence and summarize posteriors
out20 <- jags(jags.data, inits, parameters, "model17.txt",
    n.iter=ni, n.burnin=nb, n.chains=nc, n.thin=nt, n.adapt=na, parallel=TRUE)
