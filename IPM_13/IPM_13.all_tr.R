...
# Run time for test script 40 mins
...
out1 <- jags(jags.data, inits, parameters, "model1.txt",
    n.iter=ni, n.burnin=nb, n.chains=nc, n.thin=nt, n.adapt=na, parallel=T)
...
# Parameters monitored
parameters <- c("mean.s", "Sigma", "mean.rho", "sigma.rho", "xi", "zeta", "mean.p", "sigma.p", "sigma.y", "sur", "pt", "rho", "kappa", "N", "U", "Ns", "NB", "G")
...
# Call JAGS (ART 554 min) and check convergence
out4 <- jags(jags.data, inits, parameters, "model4.txt", n.iter=ni, n.burnin=nb, n.chains=nc, n.thin=nt, n.adapt=na, parallel=T)
...
par(mfrow=c(3,2), mar=c(1, 4, 2, 1))
d <- 0.2
plot(y=out1$mean$sur[1,1,], x=(1:nyears)+0.5, type="b", pch=16, ylim=c(0, 1), axes=F, xlab=NA, ylab=expression(paste("Survival probability (", phi,")")), col=cl[1])
...
par(mar=c(1, 4, 2, 1))
d <- 0.2
plot(y=out1$mean$sur[2,1,], x=(1:nyears)+0.5, type="b", pch=16, ylim=c(0, 1), axes=F, xlab=NA, ylab=NA, col=cl[1])
...
par(mar=c(1, 4, 2, 1))
d <- 0.2
plot(out1$mean$kappa[1,1,], type="b", pch=16, ylim=c(0, 1), axes=F, xlab=NA, ylab=expression(paste("Probability to be present (", kappa, ")")), col=cl[1])
...
# Males
par(mar=c(1, 4, 2, 1))
plot(out1$mean$kappa[2,1,], type="b", pch=16, ylim=c(0, 1), axes=F, xlab=NA, ylab=NA, col=cl[1])
...
d <- 0.15
par(mar=c(3, 4, 2, 1))
plot(y=out1$mean$N[1,1,], x=(1:nyears)-0.5*d, type="b", pch=16, ylim=c(0, 50), axes=F, xlab=NA, ylab="Numbers", col=cl[1])
...
# Males
par(mar=c(3, 4, 2, 1))
plot(y=out1$mean$N[2,1,], x=(1:nyears)-0.5*d, type="b", pch=16, ylim=c(0, 50), axes=F, xlab=NA, ylab=NA, col=cl[1])
...
plot(out1$mean$rho[2,], type="b", pch=16, ylim=c(0.7, 1), axes=F, xlab=NA, ylab=expression(paste('Productivity  (', rho[2], ')')))
...
par(mar=c(3, 4, 2, 1))
d <- 0.25
plot(out1$mean$U, type="b", pch=16, ylim=c(0, 100), axes=F, col=cl[1], xlab=NA, ylab="Number")
...
legend("bottomright", pch=c(16, 16, 18), col=c(rev(cl), alpha("orange", 0.7)), legend=c("Superpopulation", "Colony size", "Population count"), bty="n")
...
par(mfrow=c(3,2), mar=c(1, 4, 2, 1))
plot(density(out1$sims.list$mean.s[,1,1]), ylim=c(0, 10), xlim=c(0.2, 1), col=cl[1], axes=F, ylab="Density", xlab=NA, main=NA, lwd=lw)
...
par(mar=c(1, 1, 2, 1))
plot(density(out1$sims.list$mean.s[,2,1]), ylim=c(0, 10), xlim=c(0.2, 1), col=cl[1], axes=F, ylab="Density", xlab=NA, main=NA, lwd=lw)
mtext(expression(phi[1]), side=1, line=1)
mtext('Males', side=3, line=0.5)
axis(2, las=1, labels=NA)
axis(1, labels=NA)
...
par(mar=c(1, 4, 2, 1))
plot(density(out1$sims.list$mean.s[,1,2]), ylim=c(0, 10), xlim=c(0.2, 1), col=cl[1], axes=F, ylab="Density", xlab=NA, main=NA, lwd=lw)
...
par(mar=c(1, 1, 2, 1))
plot(density(out1$sims.list$mean.s[,2,2]), ylim=c(0, 10), xlim=c(0.2, 1), col=cl[1], axes=F, ylab="Density", xlab=NA, main=NA, lwd=lw)
mtext(expression(phi[2]), side=1, line=1)
axis(2, las=1, labels=NA)
axis(1, labels=NA)
...
par(mar=c(4, 4, 2, 1))
plot(density(out1$sims.list$mean.s[,1,3]), ylim=c(0, 20), xlim=c(0.2, 1), col=cl[1], axes=F, ylab="Density", xlab=NA, main=NA, lwd=lw)
...
par(mar=c(4, 1, 2, 1))
plot(density(out1$sims.list$mean.s[,2,3]), ylim=c(0, 20), xlim=c(0.2, 1), col=cl[1], axes=F, ylab="Density", xlab=NA, main=NA, lwd=lw)
mtext(expression(phi[3]), side=1, line=2.5)
axis(2, las=1, labels=NA)
axis(1)
...
legend("topleft", lwd = rep(lw,4), col = cl, legend = c(expression(paste('IPM'[1],': ',rho[1],' = 0')), expression(paste('IPM'[2],': ',rho[1],' = 0.99')), expression(paste('IPM'[3],': ',rho[1],' ~ U(0,1)')), expression(paste('IPM'[4],': ',rho[1],' ~ Beta(3.9,5.8)'))), bty = "n")
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
plot(density(out1$sims.list$mean.rho[,2]), ylim=c(0, 15), xlim=c(0.6, 1), col=cl[1], axes=F, ylab="Density", xlab=NA, main=NA, lwd=lw)
...
legend("topleft", lwd=rep(1, 4), col=cl, legend=c(expression(paste('IPM'[1],': ',rho[1],' = 0')), expression(paste('IPM'[2],': ',rho[1],' = 0.99')), expression(paste('IPM'[3],': ',rho[1],' ~ U(0,1)')), expression(paste('IPM'[4],': ',rho[1],' ~ Beta(3.9,5.8)'))), bty="n")

par(mar=c(3.5, 4, 2, 1))
plot(density(out1$sims.list$U[,29]), ylim=c(0, 0.3), xlim=c(35, 65), col=cl[1], axes=F, ylab="", xlab=NA, main=NA, lwd=lw)
...
par(mar=c(3.5, 4, 2, 1))
plot(density(out1$sims.list$sigma.y), ylim=c(0, 0.3), xlim=c(0, 12), col=cl[1], axes=F, ylab="Density", xlab=NA, main=NA, lwd=lw)
...
par(mar=c(3.5, 4, 2, 1))
plot(ipm1, type="l", ylim=c(0, 3500), xlim=c(18, 42), col=cl[1], axes=F, ylab="", xlab=NA, main=NA, lwd=lw, frame.plot=F)
...
par(mar=c(4, 4, 2, 1))
plot(densityFolded (out3$sims.list$mean.rho[,1]), ylim=c(0, 3), xlim=c(0, 1), col=cl[1], axes=F, ylab="Density", xlab=NA, main=NA, lwd=lw)
...
legend("topright", lwd = rep(2,4), lty = c(1,2,1,2), col =cl[c(1,1,2,2)], legend = c(expression('Posterior under IPM'[3]), expression(paste('Prior in IPM'[3],' prior')), expression('Posterior under IPM'[4]), expression(paste('Prior in IPM'[4],' prior'))), bty = "n")
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
